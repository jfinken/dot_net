...
namespace GlobalHooksTest
{
	public class Form1 : System.Windows.Forms.Form
	{
		...
		public Form1()
		{
            ...
            // jf - auto start the window hooks
            _GlobalHooks.CBT.Start();
            // start the app completely minimized
        ...
        void MouseLL_MouseDown(object sender, MouseEventArgs e)
        {
			this.LblMouse.Text = "Mouse click at: " + e.X + ", " + e.Y;
        }
		...
		private void _GlobalHooks_CbtActivate(IntPtr Handle)
		{
			this.ListCbt.Items.Add("Activate: " + GetWindowName(Handle));
             ...
             using (var ss = new SpeechSynthesizer())
                    ss.Speak(GetWindowName(Handle));
            

            /*
            ProcessStartInfo st = new ProcessStartInfo();
            st.FileName = "C:\\Users\\josh\\Downloads\\SayStatic.exe";
            st.Arguments = GetWindowName(Handle);
            Process.Start(st);
            //Process.Start("C:\\Users\\josh\\Downloads\\SayStatic.exe " + GetWindowName(Handle));
             */
